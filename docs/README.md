...
_Defined in [types.ts:16](https://github.com/StylusFrost/flureejs-tx/blob/7429029/src/types.ts#L16)_
...
_Defined in [types.ts:11](https://github.com/StylusFrost/flureejs-tx/blob/7429029/src/types.ts#L11)_
